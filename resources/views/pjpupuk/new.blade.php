...
<section class="content">
    ...
    <div >
        <form role="form" action="pjpupuk/new" method="POST">
        <!-- general form elements disabled -->
        <div class="box box-warning">
            <div class="box-header">
                <!--<h3 class="box-title">Input data agenda tanam </h3>-->
                <a  class="btn btn-warning pull-right" href="pjpupuk" ><i class="fa fa-angle-double-left"></i> Kembali</a>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td>Periode Tanam</td>
                            <td>
                                <select name="periode" class="col-md-4">
                        ...
                        <tr>
                            <td>Tanggal</td>
                            <td>
                                <input type="text" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask class="col-md-4" placeholder="dd/mm/yyyy" value="{{date('d/m/Y')}}" />
                            </td>
                        </tr>
                        <tr>
                            <td>Petani</td>
                            <td>
                                <input type="text" name="petani" class="col-md-4"  />
                            </td>
                        </tr>
                        <tr>
                            <td>Kapasitas</td>
                            <td>
                                <input type="text" name="jumlah" class="col-md-2 text-right" />Kg
                            </td>
                        </tr>
                        <tr>
                            <td>Harga/Kg </td>
                            <td>
                                <input type="text" name="jumlah" class="col-md-4 text-right" />
                            </td>
                        </tr>
                        <tr>
                            <td>Total(Rp) </td>
