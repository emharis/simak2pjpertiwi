...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            ...
            <a href="pjpupuk/new" class="pull-right btn btn-success"><i class="fa fa-plus"></i> &nbsp;&nbsp;Tambah</a>
        </div><!-- /.box-header -->
        <div class="box-body">
            <div class="col-md-6">
...
<!--                    <tr>
            ...
            <div class="col-md-6">
                <table class="table table-bordered label-waring">
                    <tr>
                        <td>TERHUTANG :</td>
                        <td class="text-right">250 (Kg)</td>
            ...
            <div class="col-md-12">
                ...
                <tbody>
                    <tr >
                        ...
                        <td>Toni</td>
                        <td>01-25-2015</td>
                        <td class="text-right">30Kg</td>
                        <td class="text-right">4.500.000</td>
                        <td>Terhutang</td>
                        <td class="text-center"><a class="btn btn-xs btn-default" href="pjpupuk/edit"><i class="fa fa-folder-open" ></i></a></td>
                    </tr>
                    <tr class="label-success" >
                        <td>2</td>
                        <td>Rockamat</td>
                        <td>01-25-2015</td>
                        <td class="text-right">25Kg</td>
