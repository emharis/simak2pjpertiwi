...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="master/sopir">Sopir</a></li>
    ...
    <div >
        ...
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Edit data sopir  </h3>
                <a  class="btn btn-warning pull-right" href="master/sopir" ><i class="fa fa-angle-double-left"></i> Kembali</a>
            </div><!-- /.box-header -->
            <div class="box-body">
                <form role="form" action="master/sopir/new" method="POST">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="img/sopir/dsc_7337.jpg" id="img-foto" style="max-height: 200px;" class="col-sm-12" >
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="">
                                        <a  class="btn btn-warning" href="master/sopir" ><i class="fa fa-angle-double-left"></i> Kembali</a>
