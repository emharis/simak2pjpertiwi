...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <!--<h3 class="box-title">Tabel data pinjaman panen petani</h3>-->
            <a href="pjpanen/new" class="pull-right btn btn-success"><i class="fa fa-plus"></i> &nbsp;&nbsp;Tambah</a>
        </div><!-- /.box-header -->
        <div class="box-body">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                ...
                <tbody>
                    <tr >
                        ...
                        <td>4.500.000</td>
                        <td>Terhutang</td>
                        <td class="text-center"><a class="btn btn-xs btn-default" href="pjpanen/edit"><i class="fa fa-folder-open" ></i></a></td>
                    </tr>
