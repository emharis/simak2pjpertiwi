...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel data petani</h3>
            <a href="master/petani/new" class="pull-right btn btn-success"><i class="fa fa-plus"></i> &nbsp;&nbsp;Tambah</a>
        </div><!-- /.box-header -->
        <div class="box-body">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-xs btn-primary" href="master/petani/edit/1"><i class="fa fa-edit"></i></a>
