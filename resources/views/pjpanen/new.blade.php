...
<section class="content">
    ...
    <div >
        <form role="form" action="pjpanen/new" method="POST">
        <!-- general form elements disabled -->
        <div class="box box-warning">
            <div class="box-header">
                <!--<h3 class="box-title">Input data agenda panen </h3>-->
                <a  class="btn btn-warning pull-right" href="pjpanen" ><i class="fa fa-angle-double-left"></i> Kembali</a>
            </div><!-- /.box-header -->
            <div class="box-body">
